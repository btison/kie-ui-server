package org.jboss.btison.kie.services.impl.form;
...
public class FormProviderServiceImpl implements FormProviderService {
    ...
    public String getFormDisplayTask(long taskId) {
        ...
        Task task  = restClient.getTaskById(taskId);
        ...
        if (inputContentId != -1) {
            ...
            Content content = additionalRestClient.getContentById(inputContentId);
        ...
        if (outputContentId != -1) {
            AdditionalRestClient additionalRestClient = new AdditionalRestClient();
            Content content = additionalRestClient.getContentById(outputContentId);
